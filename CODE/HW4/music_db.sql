...
CREATE TABLE `album` (
  ...
  KEY `Artist` (`Artist`),
  CONSTRAINT `album_ibfk_1` FOREIGN KEY (`Artist`) REFERENCES `artist` (`Name`)
...
CREATE TABLE `song` (
  ...
  KEY `Artist` (`Artist`),
  CONSTRAINT `song_ibfk_1` FOREIGN KEY (`Artist`) REFERENCES `artist` (`Name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-29 17:47:16
